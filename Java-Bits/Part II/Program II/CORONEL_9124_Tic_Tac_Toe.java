...
//Program 2
//Tic Tac Toe
//Completed On June 29, 2014

import java.util.Scanner;
import java.util.Random;

public class CORONEL_9124_Tic_Tac_Toe {
	...
	public static void main(String[] args) {
		...
		char[][] CORONEL_9124_Board = new char[total_rows][total_columns]; //creating game CORONEL_9124_Board with 2D array not 1D array
		...
		do { //do while loop for playAgain method
			...
			System.out.print("Welcome to FRANCES CS Tic-Tac-Toe\n"); //intro statement
			
			clearBoard(CORONEL_9124_Board);
			printBoard(CORONEL_9124_Board); //printing CORONEL_9124_Board
			...
			turn = 0; //user's turn!
	      	...
	      	userTurn(CORONEL_9124_Board, user_symbol); // user puts his/her first tic

			printBoard(CORONEL_9124_Board); //show CORONEL_9124_Board
			...
			while (!done && remainCount > 0) {
				...
				done = checkWin(CORONEL_9124_Board, turn, user_symbol, comp_symbol); //if somebody won, set winner and done bool to true
				...
				if (done) { //one who made last turn wins game 
					...
					if (turn == 0)
						userTurn(CORONEL_9124_Board, user_symbol);
					else
						computerTurn(CORONEL_9124_Board, comp_symbol);
			...
			checkTie(CORONEL_9124_Board, winner); //tie method printing who won, lost, or if tie
			
			//clearing CORONEL_9124_Board for start of possible new game
			clearBoard(CORONEL_9124_Board);
		...
		System.out.println("This program is completed by FRANCES, COMPUTER SCIENCE, 00319124.");
	...
	*/
	...
	//clearing CORONEL_9124_Board method
	...
	//print CORONEL_9124_Board method
...
Welcome to FRANCES CS Tic-Tac-Toe
