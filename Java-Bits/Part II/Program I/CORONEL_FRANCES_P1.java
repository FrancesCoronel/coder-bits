...
FVCproductions
CS152
CORONEL_FRANCES_P1.java - Applicaiton
This application works with the class Person.java
This application prints out a table within a new text file of all the updated data depending on Person's action from a text file

TO NOTE: I called this Java file CORONEL_FRANCES_P1.java although it is noted in the rubric on page 5 to call it 
CORONEL_FRANCES.java instead, but since the former file name appeared more often, I used CORONEL_FRANCES_P1.java
*/
...
class CORONEL_FRANCES_P1 {
	...
	public static void main(String[] args) throws IOException { //main method with IOException for file writing
		...
		PrintWriter out = new PrintWriter("CORONEL_9124_P1_Output.txt"); //creating file that all data will be written to
		...
		while (fileScan.hasNext()) {
			...
			noPerson_FVC += 1; //incrementing number of persons
		...
		out.println("---------------------------------------------------------------------------");
		out.println("There are " + noPerson_FVC + " persons on the list: " + work_count + " works, " + shop_count + " shops, and " + invalid_count + " invalid-action code.");
		out.println();
		out.println("End - FRANCES Company");
