...
public class Lab9_F_Coronel {
	...
	public static void main (String[] args) throws IOException { //adding throw clause
      ...
      */
      ...
      //creating data file with Notepad called "lab9Data.txt"
		PrintWriter outputFile = new PrintWriter("lab9Data.txt");
      ...
      */
      ...
      //loop printing out increments of 15 from 15-150
      double sum = 0;
      ...
      //while loop that will print out "CSC-151 while loop" until you enter in -111
      out.println();
      ...
      while (num != -111) {
         ...
         out.println("CSC-151 while loop");
